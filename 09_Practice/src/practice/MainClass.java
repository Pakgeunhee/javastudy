...
public class MainClass {
	...
	*/
	...
	// 파일이 저장된 디렉터리는 지워지지 않으므로 먼저 디렉터리에 저장된 파일을 삭제해야 합니다.
	public static void ex03() {
		
		File dir = new File("C:" + File.separator + "storage");
		
		/* 저장된 파일이 myfile.txt 뿐이라는 걸 알고 있을 경우,
		...
		*/
		...
		// 저장된 모든 파일을 지운다는 코드(디렉터리는 없다는 가정)
	...
	// 문제6. C:\storage\diary.txt 파일을 C:\storage2\diary.txt파일로 이동하시오.
	// 이동에 소요된 시간을 출력하시오.
	...
	// 문제7. Sysytem.in은 키보드로부터 바이트 데이터를 입력 받는 InputStream이다.
