...
public class MainClass {
	...
	public static void ex02() {
		...
		// 3. NOT : !, 조건이 true이면 false, 조건이 false이면 true
	...
	public static void ex05() {
		...
		// 조건 연산
		// (조건식) ? true 일 때 처리 : false 일 때 처리 (= 삼항연산자)
	...
	public static void ex06() { // 연습
		...
		String result1 = (n % 2 == 0) ? "짝수" : "홀수";  // 짝수, 홀수, 3의배수
	...
	public static void ex07() {  // 연습
		...
		String result2 = (n != 0 && n % 3 == 0) ? "3의배수" : (n % 2 == 0) ? "짝수" : "홀수";  // 짝수, 홀수, 3의배수
