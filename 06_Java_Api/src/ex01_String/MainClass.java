...
public class MainClass {
	...
	public static void literal() {
		...
		// 기본에 사용한 리터럴을 재사용한다.("hello"라는 리터럴이 2개 이상 만들어 지지 않는다.)
	...
	public static void lastIndexOf() {
		...
		int idx2 = slogan.lastIndexOf("박근희");
	...
	public static void contains() {
		...
		String email = "pakgeunhee@gmail.com";
	...
	public static void replace() {
		...
		String replacedIp1 = ip.replace(".", "_");// 61_78_121_242
		String replacedIp2 = ip.replaceAll(".", "_");// 61_78_121_242을 기대하지만 다른 정답이 나옴(정규식에서 마침표는 모든 문자를 의미함)
	...
	public static void isEmpty() {
		...
		// isEmpty를 이용하여 공백도 빈 문자열로 처리하고싶은 경우
		if(str.trim().isEmpty()) {
			System.out.println("빈 문자열이다.");
		} else {
			System.out.println("빈 문자열이 아니다.");
	...
	public static void ex02() {
		...
		if(fullName.endsWith(".tar.gz")) {
			...
			fileName = fullName.substring(0, fullName.lastIndexOf("."));  // a.p.p.l.e
			extName = fullName.substring(fullName.lastIndexOf("."));  // .tar.gz
		}
