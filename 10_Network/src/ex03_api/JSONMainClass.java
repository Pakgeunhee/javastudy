...
public class JSONMainClass {
	...
	public static void ex02() {
		...
		try {
			...
			for(int i = 0; i < items.length(); i++) {
				JSONObject item = items.getJSONObject(i);
				System.out.println(item.get("frcstOneDt") + " : " + item.getString("frcstOneCn"));
				System.out.println(item.get("frcstTwoDt") + " : " + item.getString("frcstTwoCn"));
				System.out.println(item.get("frcstThreeDt") + " : " + item.getString("frcstThreeCn"));
